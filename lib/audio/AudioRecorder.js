...
let AudioRecorder = /** @class */ (() => {
    class AudioRecorder {
        static captureMicAudio() {
            ...
            function callback(_fn) {
                ...
                return function (stream) {
                    ...
                    var resampler = new Resampler_1.default(AudioRecorder.audioContext.sampleRate, 16000, 1, 1024);
        ...
        static concatFloat32Arrays(a, b) {
    ...
    AudioRecorder.audioData = new Float32Array(0);
    AudioRecorder.captureAudioData = false;
